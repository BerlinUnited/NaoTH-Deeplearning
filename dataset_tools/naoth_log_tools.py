...
if __name__ == "__main__":
    ...
    base_path = "/home/stella/RoboCup/Repositories/naoth-deeplearning/data_logs/goredata/"
    base_path = os.path.join(base_path, "2021-05-08_19-00-00_Berlin_United_vs_Bembelbots_half2/game_logs/0_15_Nao0068_210508-1538")
    
    image_log = os.path.join(base_path, "images.log")
    game_log = os.path.join(base_path, "game.log")
    output_log = os.path.join(base_path, "combined.log")
