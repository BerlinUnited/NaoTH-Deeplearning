...
def download_runswift_segmentation_dataset():
    ...
    download_function(
        "https://logs.naoth.de/Experiments/RunswiftDatasets/Downloads.zip", f"{data_root_path}/Downloads.zip"
    )
    download_function("https://arxiv.org/pdf/2108.12809.pdf", f"{data_root_path}/segmentation_dataset.pdf")
