...
def generate_field_detection_dataset():
    ...
    download_function(
        "https://sibylle.informatik.uni-bremen.de/public/datasets/fieldboundary/fieldboundary.hdf5",
        f"{bhuman_root_path}/fieldboundary.hdf5",
    )
    download_function(
        "https://sibylle.informatik.uni-bremen.de/public/datasets/fieldboundary/labels-as-csv.zip",
        f"{bhuman_root_path}/labels-as-csv.zip",
    )
    download_function(
        "https://sibylle.informatik.uni-bremen.de/public/datasets/fieldboundary/readme.txt",
