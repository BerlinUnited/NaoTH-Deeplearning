...
def start_train(args):
    with mlflow.start_run() as run:
        ...
        # Train the model
        results = model.train(data=Path("datasets") / args.dataset, epochs=1, batch=32, patience=100, workers=12, verbose=True, device=0)
...
if __name__ == "__main__":
    ...
    mlflow.set_experiment(f"YOLOv8 Full Size - {args.camera}")
