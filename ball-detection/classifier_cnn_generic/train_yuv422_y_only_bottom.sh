...
mlflow_experiment="Ball Classifier CNN YUV422 Y-Only Bottom"
input_shape="16 16 1"
epochs=2000
batch_size=12880
data_train="../data/classification_patches_yuv422_y_only_bottom_16x16_train_ball_no_ball_X_y.h5"
data_val="../data/classification_patches_yuv422_y_only_bottom_16x16_validation_ball_no_ball_X_y.h5"
data_test="../data/classification_patches_yuv422_y_only_bottom_16x16_test_ball_no_ball_X_y.h5"
