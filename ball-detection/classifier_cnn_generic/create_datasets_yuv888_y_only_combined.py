...
if __name__ == "__main__":
    ...
    print("Converting devils data to grayscale numpy arrays...")
    X_train_devils, y_train_devils = get_classification_data_devils_combined(
        file_path=DEVILS_SAVE_DIR_EXTRACTED,
        patch_size=(16, 16),
        color_mode=ColorMode.YUV888_Y_ONLY,
    )

    print("Converting naoth training data to grayscale numpy arrays...")
    ...
    with h5py.File(
        "classification_patches_yuv888_y_only_devils+naoth_train_ball_no_ball_X_y.h5",
        "w",
    ) as f:
        f.create_dataset("X", data=X_train)
        f.create_dataset("y", data=y_train)

    with h5py.File("classification_patches_yuv888_y_only_devils+naoth_val_ball_no_ball_X_y.h5", "w") as f:
    ...
    # print("Converting naoth test data to grayscale numpy arrays...")
    ...
    # with h5py.File(
    #     "classification_patches_yuv888_y_only_naoth_test_ball_no_ball_X_y.h5", "w"
    # ) as f:
