...
The name of the current trained model (folder_name, e.g. yolo_{camera}_run_{current_time}) need to be set with -m. If you don't know, just run once without -m and select the model you want, shown in the terminal. 
