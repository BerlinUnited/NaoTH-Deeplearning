...
def main():
    parser = argparse.ArgumentParser(description="Test script to push mock predictions to a Label Studio task.")
    parser.add_argument("-t", "--task", type=int, required=True, help="The ID of the specific Label Studio Task")
